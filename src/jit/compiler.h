...
public:
    ...
    {
#ifdef DEBUG
        assert(tdNum < 0); // temps must have a negative number (so they have a different number from all local
                           // variables)
...
protected:
    ...
    void fgInstrumentMethodHotCodeTest();
...
#define LPFLG_ASGVARS_INC                                                                                              \
    0x8000 // "lpAsgVars" is incomplete -- vars beyond those representable in an AllVarSet
