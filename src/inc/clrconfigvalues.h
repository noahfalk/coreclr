...
RETAIL_CONFIG_DWORD_INFO(UNSUPPORTED_TieredCompilation_Tier1CallRateThreshold, W("TieredCompilation_Tier1CallRateThreshold"), 30, "Number of times a method must be called in a timer tick interval (16ms) after which it is promoted to tier 1.")
RETAIL_CONFIG_DWORD_INFO(UNSUPPORTED_TieredCompilation_Tier2CallRateThreshold, W("TieredCompilation_Tier2CallRateThreshold"), 1000, "Number of times a method must be called in a timer tick interval (16ms) after which it is promoted to tier 2.")
